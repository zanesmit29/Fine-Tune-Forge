...
export const trainingJobsTable = pgTable("training_jobs", {
  ...
  maxSeqLength: integer("max_seq_length"),
  ...
  epochLosses: text("epoch_losses"),
  classes: text("classes"),
  perClassMetrics: text("per_class_metrics"),
  confusionMatrix: text("confusion_matrix"),
  macroF1: real("macro_f1"),
  weightedF1: real("weighted_f1"),
  sampleInstruction: text("sample_instruction"),
